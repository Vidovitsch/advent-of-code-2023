...
if __name__ == '__main__':
  (Puzzle('Day 7: Camel Cards (part 1)', CURRENT / 'input.txt')
    .add_test({ 'input_path': CURRENT / 'test_1.txt', 'expected_result': 6440 })
    .add_test({ 'input_path': CURRENT / 'input.txt', 'expected_result': 250946742 })
    .solve(solve))
